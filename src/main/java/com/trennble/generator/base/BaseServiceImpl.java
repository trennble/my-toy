package com.trennble.generator.base;
 ...
 * 通用serviceImpl
 */
public class BaseServiceImpl<M extends com.baomidou.mybatisplus.core.mapper.BaseMapper<T>, T> extends ServiceImpl<M, T> {
    ...
    public boolean saveBatch(Collection<T> entityList) {
        return saveBatch(entityList, BATCH_SAVE_SIZE);
    }
    ...
    public boolean saveBatch(Collection<T> entityList, int batchSize) {
        ...
        int[] result = batch(sessionFactory,sql.toString(), StrUtil.join(SEPARATOR,fieldSet), mapList, batchSize);
